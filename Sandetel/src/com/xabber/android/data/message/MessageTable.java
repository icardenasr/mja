...
class MessageTable extends AbstractEntityTable {
	...
	private static final class Fields implements AbstractEntityTable.Fields {
		 ...
		 * Consigna Object
		 */
		public static final String ID_CONSIGNA = "id_consigna";

		// /**
		// * Whether message is consgina file.
		// */
		// public static final String CONSIGNA = "consigna";
	...
	public void create(SQLiteDatabase db) {
		...
		sql = "CREATE TABLE " + NAME + " (" + Fields._ID
				...
				+ " BOOLEAN," + Fields.TAG + " TEXT," + Fields.ID_CONSIGNA
				+ " NUMBER);";
	...
	public void migrate(SQLiteDatabase db, int toVersion) {
		...
		case 67:
			...
			sql = "ALTER TABLE messages ADD COLUMN id_consigna NUMBER;";
			DatabaseManager.execSQL(db, sql);
	...
	long add(String account, String bareAddress, String tag, String resource,
			...
			boolean error) {
		return add(account, bareAddress, tag, resource, text, action,
				timeStamp, delayTimeStamp, incoming, read, sent, error, null);
	}
	...
	long add(String account, String bareAddress, String tag, String resource,
		...
		synchronized (insertNewMessageLock) {
			...
			if (idConsigna != null) {
				insertNewMessageStatement.bindLong(13, idConsigna);
			}
	...
	static Integer idConsigna(Cursor cursor) {
		return cursor.getInt(cursor.getColumnIndex(Fields.ID_CONSIGNA));
	}
