...
public class AccountItem extends ConnectionItem {
	...
	protected void onAuthFailed() {
		...
		// Interceptamos la notificación de error de autentificación y volvemos
		// al login
		...
		if (application != null) {
			...
			// progressDialog
			// .setMessage(context.getString(R.string.application_state_closing));
		...
		// ActivityManager.getInstance().getContactListActivity();

		// Quitamos la notificación
