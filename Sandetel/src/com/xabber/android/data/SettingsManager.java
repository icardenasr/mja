...
public class SettingsManager implements OnInitializedListener,
	...
	public static boolean contactsAutomaticDownload() {
		return getBoolean(R.string.contacts_automatic_download_key,
				R.bool.contacts_automatic_download_default);
	}

	public static String contactsAutomaticDownloadMB() {
		return getString(R.string.contacts_automatic_download_mb_default,
				R.string.contacts_automatic_download_mb_default);
	}
