...
//					.getString(R.string.muc_invite_confirm, accountName.split("@")[0],
//							inviterName.split("@")[0], user.split("@")[0]);
//		else
//			return Application.getInstance().getString(
//					R.string.muc_invite_confirm_reason, accountName,
//					inviterName.split("@")[0], user.split("@")[0], reason.split("@")[0]);
		
		
		return Application.getInstance()
				.getString(R.string.muc_invite_custom, 
						 user.split("@")[0],accountName.split("@")[0]);
