...
public class RoomChat extends AbstractChat {
	...
	private static final String ID_NOT_AVAILABLE = "ID_NOT_AVAILABLE";
	private static final String noShowspecificMessage = "Sala no anónima";
	...
	protected boolean onPacket(ConnectionItem connectionItem,
		...
		if (packet instanceof Message) {
			...
			if (text.equals(noShowspecificMessage)
					&& packet != null
					&& (packet.getPacketID() == null || packet.getPacketID()
							.equalsIgnoreCase(ID_NOT_AVAILABLE))) {
				return true;
			}
