...
public class PreferenceEditor extends ManagedPreferenceActivity implements
	...
	private Preference delayPreference;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvTitulo.setText(getString(R.string.list_cont));

		findViewById(R.id.iv_options).setVisibility(View.GONE);
		...
		delayPreference = getPreferenceScreen().findPreference(
				getString(R.string.contacts_automatic_download_mb_default));

		String mb = SettingsManager.contactsAutomaticDownloadMB();

		if (mb != null) {
			String title = String.format(
					getString(R.string.contacts_automatic_download_mb_title),
					mb);

			delayPreference.setTitle(title);
		}
	...
	private boolean numberCheck(Object newValue) {
		if (!newValue.toString().equals("")
			...
			Integer i = Integer.valueOf(newValue.toString());
			...
			if (i >= 1 && i <= 5) {
				...
				Toast.makeText(
						...
						getResources().getString(
								R.string.contacts_is_an_invalid_range),
			...
			Toast.makeText(
					PreferenceEditor.this,
					getResources().getString(
							R.string.contacts_is_an_invalid_number),
					Toast.LENGTH_SHORT).show();
			return false;
		}
	}
