...
public class PageSwitcher extends ViewGroup implements AnimationListener {
	...
	private Boolean noSwipeableViewPager = false;
	...
	public void setSelection(int position) {
		...
		if (selectedView == null)
			return;
		ListView listView = (ListView) selectedView.findViewById(R.id.list);
	...
	public void setNoSwipeableViewPager(Boolean noSwipeableViewPager) {
		this.noSwipeableViewPager = noSwipeableViewPager;
	}

	public Boolean getNoSwipeableViewPager() {
		return noSwipeableViewPager;
	}
