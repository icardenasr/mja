...
public class FileTransferRequest {
	...
	public String getFileName() {
		String name = "";
		if (streamInitiation != null && streamInitiation.getFile() != null
				&& streamInitiation.getFile().getName() != null) {
			name = streamInitiation.getFile().getName();
		}
		return name;
	}
	...
	public long getFileSize() {
		long size = 0;
		if (streamInitiation != null && streamInitiation.getFile() != null) {
			size = streamInitiation.getFile().getSize();
		}
		return size;
	}
	...
	public String getDescription() {
		String desc = "";
		if (streamInitiation != null && streamInitiation.getFile() != null
				&& streamInitiation.getFile().getDesc() != null) {
			desc = streamInitiation.getFile().getDesc();
		}
		return desc;
	}
	...
	public String getMimeType() {
		String mimeType = "";
		if (streamInitiation != null && streamInitiation.getMimeType() != null) {
			mimeType = streamInitiation.getMimeType();
		}
		return mimeType;
	}
	...
	public String getRequestor() {
		String from = "";
		if (streamInitiation != null && streamInitiation.getFrom() != null) {
			from = streamInitiation.getFrom();
		}
		return from;
	}
	...
	public String getStreamID() {
		String sessionId = "";
		if (streamInitiation != null && streamInitiation.getSessionID() != null) {
			sessionId = streamInitiation.getSessionID();
		}
		return sessionId;
	}
	 ...
	 * 
	 * @return Returns the <b><i>IncomingFileTransfer</b></i> on which the file
